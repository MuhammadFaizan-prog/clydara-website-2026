            ...
            <div className="founder-photo-wrapper">
              <div className="founder-photo-card">
                ...
                <div className="founder-socials">
                  <a href="https://www.linkedin.com/in/m-rohan-baig" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="founder-social-btn">
                  ...
                  <a href="https://rohan-baig-dev.vercel.app/" target="_blank" rel="noreferrer" aria-label="Portfolio" className="founder-social-btn">
